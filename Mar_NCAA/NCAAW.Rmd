...
# 2019 M 1st Solution (With parameter optimization)
...
regresults <- read.csv("./ncaaw-march-mania-2021/WRegularSeasonDetailedResults.csv")
results <- read.csv("./ncaaw-march-mania-2021/WNCAATourneyDetailedResults.csv")
sub <- read.csv("./ncaaw-march-mania-2021/WSampleSubmissionStage1.csv")
seeds <- read.csv("./ncaaw-march-mania-2021/WNCAATourneySeeds.csv")
