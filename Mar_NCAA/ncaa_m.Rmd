...
```{r setup, include=FALSE}
regresults <- read.csv("./ncaam-march-mania-2021/MRegularSeasonDetailedResults.csv")
results <- read.csv("./ncaam-march-mania-2021/MNCAATourneyDetailedResults.csv")
sub <- read.csv("./ncaam-march-mania-2021/MSampleSubmissionStage1.csv")
seeds <- read.csv("./ncaam-march-mania-2021/MNCAATourneySeeds.csv")
```
...
https://www.kaggle.com/c/mens-machine-learning-competition-2019/discussion/89150
